...
/// client component where we are going to load all our colors from
...
export const ColorsClient: React.FC<ColorsClientProps> = ({ data }) => {
	...
	return (
		<>
			...
			{/* /Below the Data table we want to render the API lists for the colors the way we did on the settings page */}
