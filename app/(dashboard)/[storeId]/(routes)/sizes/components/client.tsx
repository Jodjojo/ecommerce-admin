...
/// client component where we are going to load all our sizes from
...
export const SizesClient: React.FC<SizesClientProps> = ({ data }) => {
	...
	return (
		<>
			...
			{/* /Below the Data table we want to render the API lists for the sizes the way we did on the settings page */}
